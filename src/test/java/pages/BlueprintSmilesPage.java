...
public class BlueprintSmilesPage  {
    ...
    public BlueprintSmilesPage goToBlueprintSmiles() {
        goToBlueprint.click();
        return this;
    }

    @Step("Проверка контента находящегося на странице")
    public BlueprintSmilesPage checkContent() {
